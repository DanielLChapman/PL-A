...
var TIMES_IN_MILI = exports.TIMES_IN_MILI = {
	one_hour: 1000 * 60 * 60,
...
function getTimePast(p) {
	var currentTime = Date.now();
	var oldTime = new Date(p.createdAt);
	var timePast = null;
...
var SearchPageApp = function (_Component) {
	...
	function SearchPageApp(props) {
		...
		_this.setSelectedObject = _this.setSelectedObject.bind(_this);
		_this.displayTitleCard = _this.displayTitleCard.bind(_this);
		return _this;
	}

	_createClass(SearchPageApp, [{
		key: 'setSelectedObject',
		value: function setSelectedObject(p) {
		...
		key: 'displayTitleCard',
		value: function displayTitleCard(p) {
			var _this2 = this;
			...
			return _react2.default.createElement(
				'section',
				{ key: p._id, style: tempP.style, className: 'search-card', onClick: function onClick() {
						_this2.setSelectedObject(p);
					} },
		...
		value: function render() {
			...
			var searchContentToExpand = null;
			if (this.state.selectedObject) {
				displayStyle = { display: "block" };

				var timePast = getTimePast(this.state.selectedObject);

				searchContentToExpand = _react2.default.createElement(
					'div',
					null,
					_react2.default.createElement(
						'h2',
					...
					_react2.default.createElement(
						...
						this.state.selectedObject.user.name,
						' || ',
						timePast
					),
					_react2.default.createElement(
						'h4',
						null,
						this.state.selectedObject.description
					),
					_react2.default.createElement('br', null),
					_react2.default.createElement(
						'a',
						{ href: '/watch/' + this.state.selectedObject.slug },
						_react2.default.createElement(
							'h5',
							null,
							'Click Here To View'
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'section',
					{ className: 'search-area col-xs-12 col-sm-12 col-md-4' },
					_react2.default.createElement(
						'h2',
						null,
						'Search: ',
				...
				_react2.default.createElement(
					'section',
					{ style: displayStyle, className: 'search-info-sheet col-xs-12 .col-sm-12 col-md-4 col-md-offset-4' },
...
function mapDispatchToProps(dispatch) {
	return (0, _redux.bindActionCreators)({ searchVideos: _index.searchVideos }, dispatch);
}

function mapStateToProps(_ref) {
	var playlists = _ref.playlists;

	return { playlists: playlists }; // {videos } === { videos: videos }
}
...
var _PopularPage = __webpack_require__(134);
...
exports.defaultPlaylist = undefined;
...
var _SearchPage = __webpack_require__(109);
...
var defaultPlaylist = exports.defaultPlaylist = {
	name: '##aa##',
	description: '',
	_id: 'abc123',
	createdAt: Date.now(),
...
var PopularPageApp = function (_Component) {
	_inherits(PopularPageApp, _Component);

	function PopularPageApp(props) {
		_classCallCheck(this, PopularPageApp);

		var _this = _possibleConstructorReturn(this, (PopularPageApp.__proto__ || Object.getPrototypeOf(PopularPageApp)).call(this, props));

		_this.state = {
			numToShow: 10,
			timeRange: _SearchPage.TIMES_IN_MILI.one_day,
			playlists: [defaultPlaylist]
		};
		_this.updateListOfPlaylists = _this.updateListOfPlaylists.bind(_this);
		_this.adjustTime = _this.adjustTime.bind(_this);
		return _this;
	}

	_createClass(PopularPageApp, [{
		key: 'componentWillMount',
		value: function componentWillMount() {
			this.updateListOfPlaylists(this.state.timeRange);
		}
	}, {
		key: 'updateListOfPlaylists',
		value: function updateListOfPlaylists(time) {
			var _this2 = this;

			_axios2.default.get('/api/v1/getPopularVideos?time=' + time + '&num=' + this.state.numToShow).then(function (response) {
				_this2.setState({
		...
		key: 'renderPlayListCard',
		value: function renderPlayListCard(p) {
			if (p.name !== "##aa##") {
				var tempP = Object.assign({}, p);
				if (tempP.name.length > 35) {
					tempP.name = tempP.name.substr(0, 32) + "...";
				...
				return _react2.default.createElement(
					'div',
					{ className: 'popular-card', key: tempP._id },
					_react2.default.createElement(
						'h4',
						null,
						tempP.name
					...
					_react2.default.createElement(
						...
						tempP.user.name,
						' || ',
						(0, _SearchPage.getTimePast)(tempP)
					),
					_react2.default.createElement(
						'h5',
						null,
				...
				return _react2.default.createElement('div', { key: 'p.name' });
			}
		}
	}, {
		key: 'adjustTime',
		value: function adjustTime(time) {
		...
		value: function render() {
			...
			var display = playlists.map(this.renderPlayListCard);
			return _react2.default.createElement(
				'div',
				{ className: 'empty-div' },
				_react2.default.createElement(
					'h1',
					{ className: 'title-text-of-page' },
					'Most Viewed Videos'
				),
				_react2.default.createElement(
					'div',
					{ className: 'popular-time-selection btn-group' },
					_react2.default.createElement(
						'button',
						{ onClick: function onClick() {
								_this3.adjustTime(_SearchPage.TIMES_IN_MILI.one_hour);
							},
					...
					_react2.default.createElement(
						'button',
						{ onClick: function onClick() {
								_this3.adjustTime(_SearchPage.TIMES_IN_MILI.one_day);
							},
							type: 'button', className: 'btn btn-primary' },
						'Past Day'
					),
					_react2.default.createElement(
						'button',
						{ onClick: function onClick() {
								_this3.adjustTime(_SearchPage.TIMES_IN_MILI.one_week);
							},
							type: 'button', className: 'btn btn-primary' },
						'Past Week'
					),
					_react2.default.createElement(
						'button',
						{ onClick: function onClick() {
								_this3.adjustTime(_SearchPage.TIMES_IN_MILI.one_month);
							},
							type: 'button', className: 'btn btn-primary' },
						'Past Month'
					),
					_react2.default.createElement(
						'button',
						{ onClick: function onClick() {
								_this3.adjustTime(_SearchPage.TIMES_IN_MILI.one_year);
							},
							type: 'button', className: 'btn btn-primary' },
						'Past Year'
					)
				...
				_react2.default.createElement(
					'div',
					{ className: 'popular-playlist-display' },
					display
				)
			);
		}
	...
	return PopularPageApp;
}(_react.Component);

exports.default = PopularPageApp;

/***/ })
/******/ ]);
//# sourceMappingURL=Popular.bundle.js.map