...
var VIDEO_SCRUB = exports.VIDEO_SCRUB = 'VIDEO_SCRUB';
var VIDEO_MOVE_UP = exports.VIDEO_MOVE_UP = 'VIDEO_MOVE_UP';
var VIDEO_MOVE_DOWN = exports.VIDEO_MOVE_DOWN = 'VIDEO_MOVE_DOWN';
var GRAB_VIDEOS = exports.GRAB_VIDEOS = 'GRAB_VIDEOS';
...
function scrubURL(element) {
	var url = element;
	var data = urlSplitter(url);
...
function searchVideos(searchTerm) {
	var url = '/api/v1/search?q=' + searchTerm;
...
function moveVideoUp(elementID, elementOrder) {
	var data = {
		id: elementID,
		order: elementOrder
	};
...
function moveVideoDown(elementID, elementOrder) {
	var data = {
		id: elementID,
		order: elementOrder
	};
...
function grabRedditData(subreddit, type, count, time) {
	var url = 'https://www.reddit.com/r/' + subreddit + '/' + type + '/.json?limit=' + count + '&t=' + time;
	var data = _axios2.default.get(url);
...
function validateVideosFromReddit(videos) {
	var data = videos;
...
var m=__webpack_require__(17),n=__webpack_require__(6),p=__webpack_require__(3),q="function"===typeof Symbol&&Symbol["for"],r=q?Symbol["for"]("react.element"):60103,t=q?Symbol["for"]("react.call"):60104,u=q?Symbol["for"]("react.return"):60105,v=q?Symbol["for"]("react.portal"):60106,w=q?Symbol["for"]("react.fragment"):60107,x="function"===typeof Symbol&&Symbol.iterator;
...
*/
var aa=__webpack_require__(2),l=__webpack_require__(18),B=__webpack_require__(19),C=__webpack_require__(3),ba=__webpack_require__(20),da=__webpack_require__(21),ea=__webpack_require__(22),fa=__webpack_require__(23),ia=__webpack_require__(24),D=__webpack_require__(6);
...
var _fluxStandardAction = __webpack_require__(99);
...
var _reactDailymotion = __webpack_require__(107);
...
var Video = function (_Component) {
	...
	function Video(props) {
		...
		_this.returnVideo = _this.returnVideo.bind(_this);
		_this.startJS = _this.startJS.bind(_this);
		_this.getStreamableEmbed = _this.getStreamableEmbed.bind(_this);
		return _this;
	}
	...
	_createClass(Video, [{
		...
		key: 'getStreamableEmbed',
		value: function getStreamableEmbed(id) {}
	}, {
		key: 'returnVideo',
		value: function returnVideo() {
			var url = '';
			switch (this.props.video.site) {
				case 'dailymotion':
					url = 'http://www.dailymotion.com/embed/video/' + this.props.video.videoID;
					if (!this.props.autoplay) {
						return _react2.default.createElement('iframe', { id: 'iframe', frameBorder: '0', style: { width: '100%', height: '100%' }, src: url, allowFullScreen: '' });
					} else {
						return _react2.default.createElement(
							'div',
							{ className: 'empty-div' },
							_react2.default.createElement(_reactDailymotion2.default, {
								video: this.props.video.videoID,
								autoplay: true,
								onEnd: this.props.nextVideo })
						);
					}
				...
				case 'youtube':
					...
					return _react2.default.createElement('iframe', { id: 'iframe', style: { width: '100%', height: '100%' }, src: url, frameBorder: '0', allowFullScreen: true });
				case 'vimeo':
					url = 'https://player.vimeo.com/video/' + this.props.video.videoID;
					if (this.props.autoplay) {
						url += '?autoplay=1;';
					}
					return _react2.default.createElement('iframe', { id: 'iframe', src: url, style: { width: '100%', height: '100%' }, frameBorder: '0', allowFullScreen: true });
				case 'streamable':
					...
					if (!this.props.autoplay) {
						...
						_axios2.default.get('https://api.streamable.com/oembed.json?url=https://streamable.com/' + this.props.video.videoID).then(function (resp) {
						...
						return _react2.default.createElement(
							'div',
							{ className: 'empty-div streamable-div' },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_load_script2__ = __webpack_require__(108);
  ...
  if (!sdk) {
    if (_typeof(window.DM) === 'object' && typeof window.DM.player === 'function') {
      ...
      sdk = new Promise(function (resolve, reject) {
        __WEBPACK_IMPORTED_MODULE_2_load_script2___default()('https://api.dmcdn.net/all.js', function (err) {
          if (err) {
            reject(err);
          } else {
            resolve(window.DM);
...
Dailymotion.propTypes = process.env.NODE_ENV !== "production" ? {
  /**
   ...
   * videos.
   */
  video: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string,
  /**
   ...
   * Pause the video.
   */
  paused: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.bool, // eslint-disable-line react/no-unused-prop-types
   ...
   */
  showEndScreen: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.bool,
  /**
   * Whether to mute the video or not.
   */
  mute: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.bool,
  /**
   ...
   */
  quality: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.oneOf(['auto', '240', '380', '480', '720', '1080', '1440', '2160']),
  /**
   * Whether to display the sharing button or not.
   */
  sharing: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.bool,
  /**
   ...
   */
  subtitles: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string,
  /**
   * Passes your syndication key to the player.
   */
  syndication: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string,
  /**
   ...
   */
  uiHighlightColor: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string,
  /**
   * Whether to display the Dailymotion logo or not.
   */
  uiShowLogo: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.bool,
  /**
   * Whether to show video information (title and owner) on the start screen.
   */
  uiShowStartScreenInfo: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.bool,
  /**
   ...
   */
  uiTheme: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.oneOf(['light', 'dark']),
   ...
   * 1.
   */
  volume: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.number,
   ...
   */
  onAdEnd: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func,
  /**
   * Sent when an Ad playback pauses.
   */
  onAdPause: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func,
  /**
   * Sent when an Ad playback starts.
   */
  onAdPlay: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func,
  /**
   * Sent when the player starts to play an Ad media resource.
   */
  onAdStart: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func,
  /**
   * Sent on each Ad's time update.
   */
  onAdTimeUpdate: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func,
  /**
   * Sent when the player is ready to accept API commands.
   */
  onApiReady: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func,
  /**
   * Sent when the duration of the video become available or change during
   * playback.
   */
  onDurationChange: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func,
  /**
   ...
   */
  onFullscreenChange: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func,
  /**
   * Sent when video's metadata are available.
   */
  onLoadedMetadata: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func,
  /**
   ...
   */
  onPlaying: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func,
  /**
   * Sent when the browser is fetching the media data.
   */
  onProgress: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func,
  /**
   * Sent when qualities are available – see `qualities` for accepted values.
   */
  onQualitiesAvailable: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func,
  /**
   * Sent when the current quality changes.
   */
  onQualityChange: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func,
  /**
   * Sent when the player has completed a seeking operation.
   */
  onSeeked: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func,
  /**
   * Sent when the player is starting to seek to another position in the video.
   */
  onSeeking: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func,
  /**
   * Sent when the current subtitle changes.
   */
  onSubtitleChange: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func,
  /**
   * Sent when subtitles are available.
   */
  onSubtitlesAvailable: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func,
  /**
   ...
   */
  onTimeUpdate: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func,
  /**
   * Sent when the player starts to play the content media resource.
   */
  onVideoStart: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func,
  /**
   * Sent when the player reaches the end of the content media resource.
   */
  onVideoEnd: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func,
  /**
   * Sent when the player volume or mute state has changed.
   */
  onVolumeChange: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func,
  /**
   * Sent when the player has to stop video playback for further buffering of
   * content.
   */
  onWaiting: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func

  /* eslint-enable react/no-unused-prop-types */
} : {};

/* harmony default export */ __webpack_exports__["default"] = (Dailymotion);
...
var _reduxPromise = __webpack_require__(98);

var _reduxPromise2 = _interopRequireDefault(_reduxPromise);

var _EditVideosApp = __webpack_require__(120);

var _EditVideosApp2 = _interopRequireDefault(_EditVideosApp);

var _editVideos = __webpack_require__(124);
...
_reactDom2.default.render(_react2.default.createElement(
  ...
  { store: createStoreWithMiddleware(_editVideos2.default) },
  _react2.default.createElement(_EditVideosApp2.default, null)
...
var _video_bar = __webpack_require__(121);

var _video_bar2 = _interopRequireDefault(_video_bar);

var _playlist_list = __webpack_require__(122);

var _playlist_list2 = _interopRequireDefault(_playlist_list);

var _edit_form = __webpack_require__(123);
...
var EditVideosApp = function (_Component) {
	_inherits(EditVideosApp, _Component);

	function EditVideosApp(props) {
		_classCallCheck(this, EditVideosApp);

		var _this = _possibleConstructorReturn(this, (EditVideosApp.__proto__ || Object.getPrototypeOf(EditVideosApp)).call(this, props));
		...
		_this.renderPasswordInformation = _this.renderPasswordInformation.bind(_this);
	...
	_createClass(EditVideosApp, [{
		...
		value: function renderPasswordInformation() {
			return _react2.default.createElement(
				'div',
				null,
				_react2.default.createElement(
		...
		key: 'renderTextInformation',
		value: function renderTextInformation() {
			return _react2.default.createElement(
				'div',
				null,
				_react2.default.createElement(
					'section',
					{ className: 'row editPageButtons' },
					_react2.default.createElement(
						'button',
						{ className: 'btn btn-default', onClick: this.viewVideos },
				...
				_react2.default.createElement(
					...
					null,
					'Editing ',
					this.props.playlist[0].name || 'Playlist'
				),
				_react2.default.createElement(_edit_form2.default, { reactID: REACT_ID, playlist: this.props.playlist[0] })
			);
		}
	}, {
		key: 'viewVideoInformation',
		value: function viewVideoInformation() {
			this.setState({
				view: 'Text',
		...
		value: function renderVideoInformation() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'button',
						{ className: 'btn btn-default', onClick: this.viewVideoInformation },
						'Edit Information About Playlist'
					),
					_react2.default.createElement(
						'a',
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(_video_bar2.default, null),
					_react2.default.createElement(
						'section',
						null,
						_react2.default.createElement(
							'ul',
							{ className: 'accepted-urls' },
							_react2.default.createElement(
								'li',
								{ style: { fontSize: '1.3em' } },
								'Accepted URLS',
								_react2.default.createElement('i', { onClick: this.checkUrls, className: 'fa fa-question-circle-o', 'aria-hidden': 'true', style: { paddingLeft: '5px' } })
							),
							_react2.default.createElement(
								'li',
								{ style: urlDisplay },
		...
		key: 'render',
		value: function render() {
			var passWordRequired = this.props.playlist[0] === 'Password Required';
	...
	return EditVideosApp;
}(_react.Component);

function mapDispatchToProps(dispatch) {
	return (0, _redux.bindActionCreators)({ grabVideos: _index.grabVideos }, dispatch);
}

function mapStateToProps(_ref) {
	var playlist = _ref.playlist;

	return { playlist: playlist }; // {videos } === { videos: videos }
}
...
var VideoBar = function (_Component) {
	_inherits(VideoBar, _Component);

	function VideoBar(props) {
		_classCallCheck(this, VideoBar);

		var _this = _possibleConstructorReturn(this, (VideoBar.__proto__ || Object.getPrototypeOf(VideoBar)).call(this, props));
	...
	_createClass(VideoBar, [{
		...
		value: function validateUrl() {
			var ele = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.state.url;
			var length = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;

			// make submit not work and border around input red until the url is a valid one
			if (_index.REGEX_OBJ.regYouTubeCom.test(ele) || _index.REGEX_OBJ.regYoutuBe.test(ele) || _index.REGEX_OBJ.VimeoCom.test(ele) || _index.REGEX_OBJ.VimeoPlayer.test(ele) || _index.REGEX_OBJ.DaiLy.test(ele) || _index.REGEX_OBJ.DailyMotionCom.test(ele) || _index.REGEX_OBJ.Streamable.test(ele)) {
				this.setState({
					validUrl: true,
					url: ele
				});
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'button',
					{ type: 'submit', style: ButtonStyle, className: 'btn btn-primary button submitButton' },
					'Submit'
				)
			);
		}
...
function mapDispatchToProps(dispatch) {
	return (0, _redux.bindActionCreators)({ scrubURL: _index.scrubURL }, dispatch);
}
...
var PlayListList = function (_Component) {
	_inherits(PlayListList, _Component);

	function PlayListList(props) {
		_classCallCheck(this, PlayListList);

		var _this = _possibleConstructorReturn(this, (PlayListList.__proto__ || Object.getPrototypeOf(PlayListList)).call(this, props));
		...
		_this.onMoveUp = _this.onMoveUp.bind(_this);
		_this.onMoveDown = _this.onMoveDown.bind(_this);
	...
	_createClass(PlayListList, [{
		...
		key: 'onMoveUp',
		value: function onMoveUp(ID, order) {
			this.props.moveVideoUp(ID, order);
		}
	}, {
		key: 'onMoveDown',
		value: function onMoveDown(ID, order) {
		...
		value: function renderVideo(videoData) {
			...
			return _react2.default.createElement(
				'div',
				{ className: 'video-card', key: videoData.id + videoData.videoID },
				_react2.default.createElement(
					'section',
					{ className: 'video-card-video' },
					_react2.default.createElement(_Video2.default, { autoplay: false, video: videoData })
				),
				_react2.default.createElement(
					'section',
				...
				_react2.default.createElement(
					'section',
					{ className: 'video-card-interactions' },
					_react2.default.createElement(
						'h5',
						null,
						'Adjust Video'
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							{ onClick: function onClick() {
									_this2.onMoveUp(videoData.id, videoData.order);
								} },
							'Move Up'
						),
						_react2.default.createElement(
							'li',
							{ onClick: function onClick() {
									_this2.onMoveDown(videoData.id, videoData.order);
								} },
							'Move Down'
						),
						_react2.default.createElement(
   	...
   	this.setState({ url: '', validUrl: false });
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'h6',
					{ className: 'playListList-Notice' },
					notice
				),
				_react2.default.createElement(
					'button',
					{ type: 'submit', onClick: this.onSubmit, style: ({ marginTop: '5px' }, savedStyling), className: 'btn btn-primary' },
					'Save Playlist'
				),
				_react2.default.createElement(
					'section',
					{ className: 'videosInPlaylists popular-playlist-display' },
					dataToReturn
				)
			);
		}
...
function mapDispatchToProps(dispatch) {
	return (0, _redux.bindActionCreators)({ moveVideoUp: _index.moveVideoUp, moveVideoDown: _index.moveVideoDown, deleteVideo: _index.deleteVideo }, dispatch);
}
...
var EditForm = function (_Component) {
	...
	function EditForm(props) {
		...
		_this.state = {
			id: _this.props.playlist._id,
			name: _this.props.playlist.name,
			description: _this.props.playlist.description,
			private: _this.props.playlist.private,
			password: _this.props.playlist.password,
			sharedEdit: _this.props.playlist.sharedEdit,
			editPassword: _this.props.playlist.editPassword,
			tags: _this.props.playlist.tags[0]
		};
		_this.onFormSubmit = _this.onFormSubmit.bind(_this);
		_this.handleInputChange = _this.handleInputChange.bind(_this);
		_this.renderPasswordField = _this.renderPasswordField.bind(_this);
		return _this;
	}
	...
	_createClass(EditForm, [{
		...
		value: function renderPasswordField(target) {
			if (target === 'password') {
				return _react2.default.createElement(
					'div',
					{ className: 'password-field', style: { position: 'relative', marginTop: '-10px' } },
					...
					_react2.default.createElement('input', { className: 'form-control', type: 'text', name: 'password', onChange: this.handleInputChange, value: this.state.password })
				);
			} else {
				return _react2.default.createElement(
					'div',
					...
					_react2.default.createElement('input', { className: 'form-control', type: 'text', name: 'editPassword', onChange: this.handleInputChange, value: this.state.editPassword })
				);
			}
		}
	}, {
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'form',
				{ onSubmit: this.onFormSubmit, className: 'card', style: { color: 'white' } },
				_react2.default.createElement(
					'div',
					{ className: 'form-group' },
					_react2.default.createElement(
					...
					_react2.default.createElement('input', { className: 'form-control', type: 'text', name: 'name', onChange: this.handleInputChange, value: this.state.name })
				),
				_react2.default.createElement(
					'div',
					{ className: 'form-group' },
					...
					_react2.default.createElement('input', { className: 'form-control', type: 'text', name: 'description', onChange: this.handleInputChange, value: this.state.description })
				),
				_react2.default.createElement(
					'div',
					{ className: 'form-group' },
					_react2.default.createElement(
						'label',
						{ htmlFor: 'private' },
						'Should this playlist be private?'
					),
					_react2.default.createElement('br', null),
					_react2.default.createElement(
						'p',
						{ className: 'private-text-area', style: { display: "inline-block", paddingRight: "5px" } },
						this.state.private.toString()
					),
					_react2.default.createElement('input', { className: 'pivate-check-box', type: 'checkbox', name: 'private', style: { display: "inline-block", paddingLeft: "10px" }, onChange: this.handleInputChange, checked: this.state.private }),
					_react2.default.createElement('br', null),
					_react2.default.createElement(
						'div',
						null,
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'label',
						{ htmlFor: 'sharedEdit' },
						'Do you want to add a password so multiple people can edit this playlist?'
					),
					_react2.default.createElement('br', null),
					_react2.default.createElement(
						'p',
						{ className: 'private-text-area', style: { display: "inline-block", paddingRight: "5px" } },
						this.state.sharedEdit.toString()
					),
					_react2.default.createElement('input', { className: 'pivate-check-box', type: 'checkbox', name: 'sharedEdit', style: { display: "inline-block", paddingLeft: "10px" }, onChange: this.handleInputChange, value: this.state.sharedEdit }),
					_react2.default.createElement('br', null),
					_react2.default.createElement(
						'div',
						null,
				...
				_react2.default.createElement(
					...
					_react2.default.createElement('textarea', { className: 'form-control', rows: '2', type: 'text', name: 'tags', onChange: this.handleInputChange, value: this.state.tags }),
					_react2.default.createElement(
						'p',
						null,
				...
				_react2.default.createElement(
					'div',
					{ className: 'form-group' },
					_react2.default.createElement('input', { className: 'btn btn-primary', type: 'submit', defaultValue: 'Save' })
				)
			);
		}
	}]);
...
var _reducer_video = __webpack_require__(125);
...
var rootReducer = (0, _redux.combineReducers)({
	playlist: _reducer_video2.default
});
...
exports.default = function () {
	...
	switch (action.type) {
		...
		case _index.VIDEO_MOVE_UP:
			...
			videosToSort.sort(function (a, b) {
				return a.order > b.order ? 1 : b.order > a.order ? -1 : 0;
			});
			state[0].videos = videosToSort;
			return [].concat(_toConsumableArray(state));
		case _index.VIDEO_MOVE_DOWN:
			videosToSort = state[0].videos;
			for (var _x2 = 0; _x2 < videosToSort.length; _x2++) {
				if (videosToSort[_x2].id === action.payload.id /*||
                                                   videosToSort[x].order === (action.payload.order - 1)*/) {
						videosToSort[_x2].order -= 1;
					}
			}
			videosToSort.sort(function (a, b) {
				return a.order > b.order ? 1 : b.order > a.order ? -1 : 0;
			...
			state[0].videos = videosToSort;
			return [].concat(_toConsumableArray(state));
		case _index.GRAB_VIDEOS:
			if (action.payload.data !== 'Password Required') {
				var _x3 = action.payload.data.videos;
				_x3.map(function (i) {
					i.id = i._id;
				});
				action.payload.data.videos = _x3;
				return [].concat(_toConsumableArray(state), [action.payload.data]);
			} else {
				return [].concat(_toConsumableArray(state), [action.payload.data]);
			}
		case _index.DELETE_VIDEO:
