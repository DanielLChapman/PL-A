...
var _ViewPlaylist = __webpack_require__(127);

var _ViewPlaylist2 = _interopRequireDefault(_ViewPlaylist);

var _watchVideos = __webpack_require__(128);

var _watchVideos2 = _interopRequireDefault(_watchVideos);
...
_reactDom2.default.render(_react2.default.createElement(
  ...
  { store: createStoreWithMiddleware(_watchVideos2.default) },
  _react2.default.createElement(_ViewPlaylist2.default, null)
...
var ViewPlaylist = function (_Component) {
	_inherits(ViewPlaylist, _Component);

	function ViewPlaylist(props) {
		_classCallCheck(this, ViewPlaylist);

		var _this = _possibleConstructorReturn(this, (ViewPlaylist.__proto__ || Object.getPrototypeOf(ViewPlaylist)).call(this, props));
	...
	_createClass(ViewPlaylist, [{
		...
		value: function componentWillMount() {
			...
			var order = parseInt(document.querySelector('.video-container').getAttribute('order'));
			this.setState({
				REACT_ID: REACT_ID,
				order: order
			});
		...
		key: 'validateOrder',
		value: function validateOrder(lengthToCompare, newOrder) {
		...
		key: 'renderPlaylist',
		value: function renderPlaylist(videos) {
			return _react2.default.createElement(_Video2.default, { autoplay: true, video: videos[this.state.order], nextVideo: this.nextVideo });
		}
	}, {
		key: 'nextVideo',
		value: function nextVideo() {
			var tempOrder = parseInt(this.state.order) + 1;
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'div',
				{ className: 'empty-div view-playlist-box' },
				_react2.default.createElement(
					'div',
					{ onClick: this.nextVideo, className: 'video-switch-button next-video-box btn btn-primary' },
					'Next \u2192 '
				),
				_react2.default.createElement(
					'div',
					{ onClick: this.prevVideo, className: 'video-switch-button prev-video-box btn btn-primary' },
					' \u2190 Prev '
				),
				data
			);
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(ViewPlaylist);
...
var _reducer_watch = __webpack_require__(129);

var _reducer_watch2 = _interopRequireDefault(_reducer_watch);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var watchReducer = (0, _redux.combineReducers)({
	playlist: _reducer_watch2.default
});

exports.default = watchReducer;
